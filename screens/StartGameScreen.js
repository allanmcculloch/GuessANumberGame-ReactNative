            ...
            <View style={styles.screen}>
                ...
                <View style={styles.inputContainer}>
                    <Card style={styles.inputContainer}>
                        ...
                        <Input style={styles.input} blurOnSubmit autoCapitaliize='none' autoCorrect={false} keyboardType="number-pad" maxLength={2} value={enteredValue} onChangeText={numberInputHander} />
